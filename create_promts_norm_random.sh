...
do
    ...
    ls $promt
    rand=$1/r00$aread\_WB_FDG_6R7/HImg/r00$aread\_WB_FDG_6R7_50m-60m_20x9_4mm_3_final.randview.img
    ls $rand
    norm=$1/r00$aread\_WB_FDG_6R7/HImg/dircor_WB_FDG_6R7_20x9_4mm.0dgns_view.img
    ls $norm
